...
export default function AttendanceAdmin() {
  ...
  return (
    <Layout title="Attendance Tracker" links={adminLinks}>
      <div style={styles.page}>
        <div style={styles.headerCard}>
          <h2 style={styles.pageTitle}>Attendance Tracker</h2>
          <p style={styles.pageText}>
            Occurrences are based on a rolling 365 day period. Coaching and Documentation occurs at 2 occurrences. Corrective Action occurs at 3 occurrences.
          </p>
        </div>
